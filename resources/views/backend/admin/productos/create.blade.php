                    ...
                    <form action="{{ route('productos.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="precio" name="precio" value="{{ old('precio') }}" min="0" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="imagen" name="imagen" placeholder="Ej: imagenes/productos/labial.png" value="{{ old('imagen') }}" required>
                        </div>

                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-dark px-4 rounded-0">GUARDAR PRODUCTO</button>
